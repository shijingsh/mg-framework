 ...
 */
public class ListElementDirective extends BaseDirective {
    ...
    private String createListLabel(MirrorPropertyEntity mirrorProperty){
        ...
        sb.append("<span class=\"icoGroup\">");
        sb.append("<a  class=\"icon_del\" title=\"删除\" ng-click=\"delStructData('").append(mirrorProperty.getPropertyPath()).append("')\"></a>");
    ...
    public String createTable(MirrorPropertyEntity mPropertyEntity){
        ...
        sb.append("<table class=\"struct_table\" >");
